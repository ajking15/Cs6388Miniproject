"""
This script is called by the plugin-wrapper, ClassificationPlug.js, which passes down the
...
from ClassificationPlug import ClassificationPlug

logger = logging.getLogger('ClassificationPlug')
...
plugin = ClassificationPlug(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
